...
Lemma congr_KiStar : KiStar = KiStar.
Proof.
exact (eq_refl).
Qed.

Lemma congr_KiArr {s0 : Ki} {s1 : Ki} {t0 : Ki} {t1 : Ki} (H0 : s0 = t0)
  (H1 : s1 = t1) : KiArr s0 s1 = KiArr t0 t1.
Proof.
exact (eq_trans (eq_trans eq_refl (ap (fun x => KiArr x s1) H0))
         (ap (fun x => KiArr t0 x) H1)).
Qed.
...
Proof.
exact (scons (TyVar var_zero) (funcomp (ren_Ty shift) sigma)).
Defined.

Fixpoint subst_Ty (sigma_Ty : nat -> Ty) (s : Ty) {struct s} : Ty :=
  match s with
  | TyVar s0 => sigma_Ty s0
...
Lemma upId_Ty_Ty (sigma : nat -> Ty) (Eq : forall x, sigma x = TyVar x) :
  forall x, up_Ty_Ty sigma x = TyVar x.
Proof.
exact (fun n =>
       match n with
...
(Eq_Ty : forall x, sigma_Ty x = TyVar x) (s : Ty) {struct s} :
...
Lemma rinstInst_up_Ty_Ty (xi : nat -> nat) (sigma : nat -> Ty)
  (Eq : forall x, funcomp (TyVar) xi x = sigma x) :
  forall x, funcomp (TyVar) (upRen_Ty_Ty xi) x = up_Ty_Ty sigma x.
Proof.
exact (fun n =>
       match n with
       | S n' => ap (ren_Ty shift) (Eq n')
...
(Eq_Ty : forall x, funcomp (TyVar) xi_Ty x = sigma_Ty x) (s : Ty) {struct s}
   :
...
Lemma rinstInst'_Ty (xi_Ty : nat -> nat) (s : Ty) :
  ren_Ty xi_Ty s = subst_Ty (funcomp (TyVar) xi_Ty) s.
Proof.
exact (rinst_inst_Ty xi_Ty _ (fun n => eq_refl) s).
Qed.

Lemma rinstInst'_Ty_pointwise (xi_Ty : nat -> nat) :
  pointwise_relation _ eq (ren_Ty xi_Ty) (subst_Ty (funcomp (TyVar) xi_Ty)).
Proof.
exact (fun s => rinst_inst_Ty xi_Ty _ (fun n => eq_refl) s).
Qed.

Lemma instId'_Ty (s : Ty) : subst_Ty (TyVar) s = s.
Proof.
exact (idSubst_Ty (TyVar) (fun n => eq_refl) s).
Qed.

Lemma instId'_Ty_pointwise : pointwise_relation _ eq (subst_Ty (TyVar)) id.
Proof.
exact (fun s => idSubst_Ty (TyVar) (fun n => eq_refl) s).
Qed.
...
Lemma varL'_Ty (sigma_Ty : nat -> Ty) (x : nat) :
  subst_Ty sigma_Ty (TyVar x) = sigma_Ty x.
Proof.
exact (eq_refl).
Qed.

Lemma varL'_Ty_pointwise (sigma_Ty : nat -> Ty) :
  pointwise_relation _ eq (funcomp (subst_Ty sigma_Ty) (TyVar)) sigma_Ty.
Proof.
exact (fun x => eq_refl).
Qed.

Lemma varLRen'_Ty (xi_Ty : nat -> nat) (x : nat) :
  ren_Ty xi_Ty (TyVar x) = TyVar (xi_Ty x).
Proof.
exact (eq_refl).
Qed.

Lemma varLRen'_Ty_pointwise (xi_Ty : nat -> nat) :
  pointwise_relation _ eq (funcomp (ren_Ty xi_Ty) (TyVar))
    (funcomp (TyVar) xi_Ty).
Proof.
exact (fun x => eq_refl).
Qed.
...
Lemma congr_TmTAbs {s0 : Ki} {s1 : Tm} {t0 : Ki} {t1 : Tm} (H0 : s0 = t0)
  (H1 : s1 = t1) : TmTAbs s0 s1 = TmTAbs t0 t1.
Proof.
exact (eq_trans (eq_trans eq_refl (ap (fun x => TmTAbs x s1) H0))
         (ap (fun x => TmTAbs t0 x) H1)).
Qed.
...
Tm :=
  ...
  | TmTAbs s0 s1 =>
      TmTAbs s0 (ren_Tm (upRen_Ty_Ty xi_Ty) (upRen_Ty_Tm xi_Tm) s1)
...
Proof.
exact (scons (TmVar var_zero) (funcomp (ren_Tm id shift) sigma)).
Defined.

Fixpoint subst_Tm (sigma_Ty : nat -> Ty) (sigma_Tm : nat -> Tm) (s : Tm)
{struct s} : Tm :=
  match s with
  | TmVar s0 => sigma_Tm s0
  | TmAbs s0 s1 =>
  ...
  | TmTAbs s0 s1 =>
      TmTAbs s0 (subst_Tm (up_Ty_Ty sigma_Ty) (up_Ty_Tm sigma_Tm) s1)
  | TmTApp s0 s1 =>
      TmTApp (subst_Tm sigma_Ty sigma_Tm s0) (subst_Ty sigma_Ty s1)
  | TmUnit => TmUnit
  end.

Lemma upId_Ty_Tm (sigma : nat -> Tm) (Eq : forall x, sigma x = TmVar x) :
  forall x, up_Ty_Tm sigma x = TmVar x.
Proof.
exact (fun n => ap (ren_Tm shift id) (Eq n)).
Qed.

Lemma upId_Tm_Ty (sigma : nat -> Ty) (Eq : forall x, sigma x = TyVar x) :
  forall x, up_Tm_Ty sigma x = TyVar x.
Proof.
exact (fun n => ap (ren_Ty id) (Eq n)).
Qed.

Lemma upId_Tm_Tm (sigma : nat -> Tm) (Eq : forall x, sigma x = TmVar x) :
  forall x, up_Tm_Tm sigma x = TmVar x.
Proof.
exact (fun n =>
       match n with
...
(Eq_Ty : forall x, sigma_Ty x = TyVar x)
(Eq_Tm : forall x, sigma_Tm x = TmVar x) (s : Tm) {struct s} :
...
Lemma rinstInst_up_Ty_Tm (xi : nat -> nat) (sigma : nat -> Tm)
  (Eq : forall x, funcomp (TmVar) xi x = sigma x) :
  forall x, funcomp (TmVar) (upRen_Ty_Tm xi) x = up_Ty_Tm sigma x.
Proof.
exact (fun n => ap (ren_Tm shift id) (Eq n)).
Qed.
...
Lemma rinstInst_up_Tm_Ty (xi : nat -> nat) (sigma : nat -> Ty)
  (Eq : forall x, funcomp (TyVar) xi x = sigma x) :
  forall x, funcomp (TyVar) (upRen_Tm_Ty xi) x = up_Tm_Ty sigma x.
Proof.
exact (fun n => ap (ren_Ty id) (Eq n)).
Qed.
...
Lemma rinstInst_up_Tm_Tm (xi : nat -> nat) (sigma : nat -> Tm)
  (Eq : forall x, funcomp (TmVar) xi x = sigma x) :
  forall x, funcomp (TmVar) (upRen_Tm_Tm xi) x = up_Tm_Tm sigma x.
Proof.
exact (fun n =>
       match n with
       | S n' => ap (ren_Tm id shift) (Eq n')
...
(Eq_Ty : forall x, funcomp (TyVar) xi_Ty x = sigma_Ty x)
(Eq_Tm : forall x, funcomp (TmVar) xi_Tm x = sigma_Tm x) (s : Tm) {struct s}
   :
...
Lemma rinstInst'_Tm (xi_Ty : nat -> nat) (xi_Tm : nat -> nat) (s : Tm) :
  ...
  subst_Tm (funcomp (TyVar) xi_Ty) (funcomp (TmVar) xi_Tm) s.
Proof.
...
Lemma rinstInst'_Tm_pointwise (xi_Ty : nat -> nat) (xi_Tm : nat -> nat) :
  pointwise_relation _ eq (ren_Tm xi_Ty xi_Tm)
    (subst_Tm (funcomp (TyVar) xi_Ty) (funcomp (TmVar) xi_Tm)).
Proof.
exact (fun s =>
       rinst_inst_Tm xi_Ty xi_Tm _ _ (fun n => eq_refl) (fun n => eq_refl) s).
Qed.

Lemma instId'_Tm (s : Tm) : subst_Tm (TyVar) (TmVar) s = s.
Proof.
exact (idSubst_Tm (TyVar) (TmVar) (fun n => eq_refl) (fun n => eq_refl) s).
Qed.

Lemma instId'_Tm_pointwise :
  pointwise_relation _ eq (subst_Tm (TyVar) (TmVar)) id.
Proof.
exact (fun s =>
       idSubst_Tm (TyVar) (TmVar) (fun n => eq_refl) (fun n => eq_refl) s).
Qed.
...
Lemma varL'_Tm (sigma_Ty : nat -> Ty) (sigma_Tm : nat -> Tm) (x : nat) :
  subst_Tm sigma_Ty sigma_Tm (TmVar x) = sigma_Tm x.
Proof.
exact (eq_refl).
Qed.

Lemma varL'_Tm_pointwise (sigma_Ty : nat -> Ty) (sigma_Tm : nat -> Tm) :
  pointwise_relation _ eq (funcomp (subst_Tm sigma_Ty sigma_Tm) (TmVar))
    sigma_Tm.
Proof.
exact (fun x => eq_refl).
Qed.
...
Lemma varLRen'_Tm (xi_Ty : nat -> nat) (xi_Tm : nat -> nat) (x : nat) :
  ren_Tm xi_Ty xi_Tm (TmVar x) = TmVar (xi_Tm x).
Proof.
exact (eq_refl).
Qed.

Lemma varLRen'_Tm_pointwise (xi_Ty : nat -> nat) (xi_Tm : nat -> nat) :
  pointwise_relation _ eq (funcomp (ren_Tm xi_Ty xi_Tm) (TmVar))
    (funcomp (TmVar) xi_Tm).
Proof.
exact (fun x => eq_refl).
Qed.
...
#[global] Instance VarInstance_Tm : (Var _ _) := @TmVar.
...
#[global]
Instance VarInstance_Ty : (Var _ _) := @TyVar.
...
Notation "'var'" := TmVar ( at level 1, only printing)  : subst_scope.

Notation "x '__Tm'" := (@ids _ _ VarInstance_Tm x)
( at level 5, format "x __Tm", only printing)  : subst_scope.

Notation "x '__Tm'" := (TmVar x) ( at level 5, format "x __Tm")  :
subst_scope.
...
Notation "'var'" := TyVar ( at level 1, only printing)  : subst_scope.

Notation "x '__Ty'" := (@ids _ _ VarInstance_Ty x)
( at level 5, format "x __Ty", only printing)  : subst_scope.

Notation "x '__Ty'" := (TyVar x) ( at level 5, format "x __Ty")  :
subst_scope.
